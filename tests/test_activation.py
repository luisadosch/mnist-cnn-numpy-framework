import unittest
from activations.relu_layer import ActivationsReLULayer as ReLU
from activations.sigmoid_layer import ActivationsSigmoidLayer as Sigmoid
from activations.softmax_layer import SoftmaxOutputLayer      as Softmax
